...
-- jobfamilie
ALTER TABLE hr.tbl_lohnguide_modellfunktion ADD CONSTRAINT tbl_lohnguide_modellfunktion_jobfamilie_fk FOREIGN KEY (jobfamilie_kurzbz)
REFERENCES hr.tbl_lohnguide_jobfamilie (jobfamilie_kurzbz) MATCH FULL
...
ALTER TABLE hr.tbl_lohnguide_modellstelle ADD CONSTRAINT tbl_lohnguide_modellstelle_modellfunktion_fk FOREIGN KEY (modellfunktion_kurzbz)
REFERENCES hr.tbl_lohnguide_modellfunktion (modellfunktion_kurzbz) MATCH FULL
ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- vertragsbestandteil
CREATE TABLE hr.tbl_vertragsbestandteil_lohnguide
(
...
ALTER TABLE hr.tbl_vertragsbestandteil_lohnguide ADD CONSTRAINT tbl_vertragsbestandteil_fk FOREIGN KEY (vertragsbestandteil_id)
REFERENCES hr.tbl_vertragsbestandteil (vertragsbestandteil_id) MATCH FULL
ON DELETE RESTRICT ON UPDATE CASCADE;

-- fachrichtung
ALTER TABLE hr.tbl_vertragsbestandteil_lohnguide ADD CONSTRAINT tbl_vertragsbestandteil_lohnguide_fachrichtung_fk FOREIGN KEY (fachrichtung_kurzbz)
REFERENCES hr.tbl_lohnguide_fachrichtung (fachrichtung_kurzbz) MATCH FULL
ON DELETE RESTRICT ON UPDATE CASCADE;

-- modellstelle
ALTER TABLE hr.tbl_vertragsbestandteil_lohnguide ADD CONSTRAINT tbl_vertragsbestandteil_modellstelle_fachrichtung_fk FOREIGN KEY (modellstelle_kurzbz)
REFERENCES hr.tbl_lohnguide_modellstelle (modellstelle_kurzbz) MATCH FULL
ON DELETE RESTRICT ON UPDATE CASCADE;