...
class Api extends Auth_Controller
{
    ...
    public function __construct() {
		...
		'getSprache' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
		'getSachaufwandtyp' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
		'getNations' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
		'getAusbildung' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
		'getStandorteIntern' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
                'getOrte' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
                'getGemeinden' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
                ...
                'getVertragsartAll' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
                ...
                'personHeaderData' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
                'personAbteilung' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
                ...
                'personContactData' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
                'upsertPersonContactData' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
                'deletePersonContactData' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
                'getKontakttyp' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
                'foto' => Api::DEFAULT_PERMISSION,
                'uidByPerson' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
                'getAdressentyp' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
                'dvByPerson' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
                'vertragByDV' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
                'getCompanyByOrget'  => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
		...
		'getCurrentVBs' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
		...
		'getUnternehmen' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
        'getGehaltstypen' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
		'getVertragsarten' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
        'getVertragsbestandteiltypen' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
		...
		'getKarenztypen' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
		'getTeilzeittypen' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
		'getFreitexttypen' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
		...
		'getStundensatztypen' => [Api::DEFAULT_PERMISSION, self::RESTRICTED_PERMISSION],
