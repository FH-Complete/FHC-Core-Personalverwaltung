    ...
    function Stammdaten()
    {
		...
		$result = array(
			'base' => array(
				...
				'component' => absoluteJsImportUrl('public/extensions/FHC-Core-Personalverwaltung/js/components/employee/BaseData.js'),
				'config' => null
			),
			'employee' => array(
				'title' => $this->p->t('person', 'mitarbeiterdaten'),
				'component' => absoluteJsImportUrl('public/extensions/FHC-Core-Personalverwaltung/js/components/employee/EmployeeData.js'),
				'config' => null
			),
			'contact' => array(
				'title' => $this->p->t('person', 'kontaktdaten'),
				'component' => absoluteJsImportUrl('public/extensions/FHC-Core-Personalverwaltung/js/components/employee/contact/ContactData.js'),
				'config' => null
			),
			'bank' => array(
				'title' => $this->p->t('person', 'bankdaten'),
				'component' => absoluteJsImportUrl('public/extensions/FHC-Core-Personalverwaltung/js/components/employee/BankData.js'),
				'config' => null
			),
			'materialexpenses' => array(
				'title' => $this->p->t('person', 'sachaufwand'),
				'component' => absoluteJsImportUrl('public/extensions/FHC-Core-Personalverwaltung/js/components/employee/MaterialExpensesData.js'),
				'config' => null
			),
			'hourlyrate' => array(
			...
			'corefunction' => array(
				...
				'component' => absoluteJsImportUrl('public/extensions/FHC-Core-Personalverwaltung/js/components/employee/EmployeeFunction.js'),
				'config' => null
			),
		);
