...
const searchbaroptions = {
  ...
  origin: 'pv21',
  types: ["person", "raum", "mitarbeiter", "mitarbeiter_ohne_zuordnung",
  /*
          "student",
          "prestudent",
          "document",
  ...
  actions: {
    ...
    raum: {
      defaultaction: {
        ...
        action: function (data) {
          const link = FHC_JS_DATA_STORAGE_OBJECT.app_root + 'cms/content.php?content_id=' + data.content_id;
          return link;
        }
      },
      childactions: [{
        ...
        type: "link",
        action: function (data) {
          const link = FHC_JS_DATA_STORAGE_OBJECT.app_root + 'cis/private/lvplan/stpl_week.php?type=ort&ort_kurzbz=' + data.ort_kurzbz;
          return link;
        }
      }, {
