export default {
  ...
  getDVByID: function(dvid) {
    var url = FHC_JS_DATA_STORAGE_OBJECT.app_root + FHC_JS_DATA_STORAGE_OBJECT.ci_router 
            + '/extensions/FHC-Core-Personalverwaltung/apis/v1/DVAPI/dvByID/' + dvid;
    return axios.get(url);
  },
  endDV: function(payload) {
    var url = FHC_JS_DATA_STORAGE_OBJECT.app_root + FHC_JS_DATA_STORAGE_OBJECT.ci_router 
            + '/extensions/FHC-Core-Personalverwaltung/apis/v1/DVAPI/endDV';
  ...
  deactivateDV: function(payload) {
    var url = FHC_JS_DATA_STORAGE_OBJECT.app_root + FHC_JS_DATA_STORAGE_OBJECT.ci_router 
            + '/extensions/FHC-Core-Personalverwaltung/apis/v1/DVAPI/deactivateDV';
    return axios.post(url, payload, {
      headers: {
        'Content-Type': 'application/json'
      }
