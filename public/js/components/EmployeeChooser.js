...
const EmployeeChooser = {
  ...
  setup(_, { emit }) {   
    ...
    const endpoint =
      protocol_host +
      "/index.ci.php/extensions/FHC-Core-Personalverwaltung/api/frontend/v1/PersonAPI/filter";
    let url = "";
    ...
    const generateImageLink = (person_id) => {
      return `${protocol_host}/index.ci.php/extensions/FHC-Core-Personalverwaltung/api/frontend/v1/PersonAPI/foto?person_id=${person_id}`;
    };
