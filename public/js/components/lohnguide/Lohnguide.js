...
export const Lohnguide = {
    ...
    setup( props, context ) {
      ...
      const lohnguideTableColumnsDef =  [        
        ...
        { title: 'Funktionszulage', field: "daten_funktionszulage", hozAlign: "right", sorter:"string", mutatorData: funktionszulageMutator, formatter: funktionzulagenFormatter, headerFilter:true, headerFilterFunc: ">=", width:150, accessorDownload: sumsDownload },
