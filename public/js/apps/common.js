...
export const searchbaroptionsRestricted = {
    types: [
        "person",
        "raum",
        "mitarbeiter",
            ...
            childactions: [
                {
                    ...
                    type: "link",
                    action: function(data) {
                        return `${protocol_host}/extensions/FHC-Core-Personalverwaltung/restricted/Employees/${data.person_id}/${data.uid}/contract`;
                    }
                },
                {
                    label: "Stammdaten",
