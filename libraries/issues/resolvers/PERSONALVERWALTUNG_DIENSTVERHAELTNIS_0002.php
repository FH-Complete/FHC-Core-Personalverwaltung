...
class PERSONALVERWALTUNG_DIENSTVERHAELTNIS_0002 implements IIssueResolvedChecker
{
	public function checkIfIssueIsResolved($params)
	{
		...
		$this->_ci->load->library('extensions/FHC-Core-Personalverwaltung/issues/plausichecks/UndurchgaengigesDienstverhaeltnis');

		// check if issue persists
		$checkRes = $this->_ci->undurchgaengigesdienstverhaeltnis->getUndurchgaengigeDienstverhaeltnisse(
