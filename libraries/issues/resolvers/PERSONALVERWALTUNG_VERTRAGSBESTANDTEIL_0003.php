...
class PERSONALVERWALTUNG_VERTRAGSBESTANDTEIL_0003 implements IIssueResolvedChecker
{
	public function checkIfIssueIsResolved($params)
	{
		...
		$this->_ci->load->library('extensions/FHC-Core-Personalverwaltung/issues/plausichecks/UeberlappendeVertragsbestandteile');

		// check if issue persists
		$checkRes = $this->_ci->ueberlappendevertragsbestandteile->getUeberlappendeVertragsbestandteile(
