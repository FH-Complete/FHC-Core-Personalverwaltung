...
/**
 * Dienstverhältnisse with type "echterdv" should have Funktion (Vertragsbestandteil).
 */
class EchteDienstverhaeltnisseOhneFunktionVertragsbestandteil extends PlausiChecker
{
	public function executePlausiCheck($params)
	{
		...
		$startDate = $this->_ci->config->item('FUNKTIONZUORDNUNG_START_DATE');
		...
		// get employee data
		$result = $this->_getEchteDienstverhaeltnisseOhneFunktionVertragsbestandteil(
			$person_id,
	...
	/**
	 * "Echte" Dienstverhaeltnisse should have a Funktion Vertragsbestandteil.
	 * @param person_id
	 ...
	 */
	private function _getEchteDienstverhaeltnisseOhneFunktionVertragsbestandteil($person_id = null, $dienstverhaeltnis_id = null, $startDate = null)
	{
